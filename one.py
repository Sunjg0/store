...
a = (253.6*10) + (86.3*60) + (96.8*43) + (135.9*63) + (65.8*63) + (49.3*120) +\
    (86.3*72)  + (253.6*69) + (86.3*35) + (253.6*140) + (86.3*90) + (135.9*24)+\
    (65.8*45) + (96.8*25) + (86.3*60) + (65.8*129) + (253.6*10) + (96.8*43) +\
    (65.8*63) + (86.3*60) + (135.9*63) + (96.8*60) + (65.8*58) + (86.3*140) +\
    (65.8*48) + (96.8*43) + (135.9*57) + (253.6*10) + (65.8*63) + (96.8*78)
print('12月份总销售额为￥：',a)
print('12月份平均销售额为￥：', a/30)
print('12月份销售总量：',10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)
print('12月份销售平均量：',(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30)
print('羽绒服销售总比：',((253.6*10)+(253.6*69)+(253.6*140)+(253.6*10)+(253.6*10))/198401)
print('牛仔裤销售总比：',(86.3*(60+72+35+90+60+60+140)/198401))
print('风衣销售总比：',(96.8*(43+25+43+60+43+78))/198401)
print('皮草销售总比：',(135.9*(63+24+63+24+63+57))/198401)
print('T恤销售总比:',(65.8*(63+45+129+63+58+48+63))/198401)
print('衬衫销售总比：',(49.3*120)/198401)
